...
int main(int argc, char const *argv[])
{
	...
	// matrix state;
	// std::vector<int> r1={2,0,2,0,2,1,2,0};
	// std::vector<int> r2={0,0,0,1,1,1,0,0};
	// std::vector<int> r3={1,1,0,1,0,1,1,1};
	// std::vector<int> r4={0,0,0,0,0,0,0,0};
	// std::vector<int> r5={0,0,0,3,0,0,0,1};
	// std::vector<int> r6={3,0,0,0,3,0,3,0};
	// std::vector<int> r7={3,0,3,3,0,3,3,3};
	// std::vector<int> r8={3,4,0,4,0,4,0,4};
	// state.push_back(r1);state.push_back(r2);state.push_back(r3);state.push_back(r4);
	// state.push_back(r5);state.push_back(r6);state.push_back(r7);state.push_back(r8);
	// print_board(state);
...
for (int k = 0; k < 100000; ++k)
{
	...
	for (int i = 0; i < t1.size(); ++i){
		...
		for (int j = 0; j < t2.size(); j = j + 2){
			// cout << "S " << t1[i][0] << ' ' << t1[i][1] << " M " <<  t2[j] << ' ' << t2[j+1] << endl;	
		}
